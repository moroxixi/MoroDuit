...
## Corpus Check
- 13 files · ~18,990 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 209 nodes · 261 edges · 24 communities (17 shown, 7 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 6 edges (avg confidence: 0.5)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `6e0d819b`
...
3. `loadKatalog()` - 8 edges
4. `renderProdukList()` - 7 edges
5. `DISCOVERY: Priview Mobile Download Failure & Baseline Spacing Tempura/Wonton` - 7 edges
6. `doPost()` - 6 edges
